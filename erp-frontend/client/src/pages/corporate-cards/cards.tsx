...
export default function CardsPage() {
  ...
  const virtualCards = mockCards.filter((c) => c.cardType === "virtual").length;
  const physicalCards = mockCards.filter((c) => c.cardType === "physical").length;
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              View and manage all corporate cards
            </p>
          </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{virtualCards}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{physicalCards}</p>
                </div>
              </div>
            </CardContent>
          </Card>
